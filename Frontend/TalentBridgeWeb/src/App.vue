      ...
      <section v-if="role === 'candidate'" class="result-stack">
        ...
        <section v-if="activeCandidateTab === 'jobs'" class="content-grid wide-left">
          <div class="panel">
            ...
            <article v-for="job in jobs" :key="job.id" class="match-card job-card-rich">
              ...
              <div class="card-actions">
                <button type="button" :disabled="appliedJobIds.has(job.id) || job.has_applied" @click="apply(job.id)">{{ appliedJobIds.has(job.id) || job.has_applied ? 'Applied' : 'Apply with CV' }}</button>
          ...
          <div class="panel">
            ...
            <div v-if="!applications.length" class="empty-state">No applications yet — apply to a role to start tracking its status here.</div>
            ...
            <div v-if="!notifications.length" class="empty-state">You're all caught up. Updates on your applications appear here.</div>
          </div>
        </section>
      </section>
